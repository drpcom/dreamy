    ...
    <>
      {fetch.allArticles.length > 0 && (
        <div className="home-container">
          ...
          <Link to="/articles">
            <button className="mobile-articles-button">Browse Articles</button>
          </Link>
          <div className="section-one">
            <FeaturedBlurb
              heading=":: Featured Entry ::"
              title={
                <Link to={`/articles/${fetch.allArticles[0].route}`}>
                  {fetch.allArticles[0].title}
                </Link>
              }
            ...
            <FeaturedBlurb
              ...
              title={
                <Link to={`/articles/${fetch.allArticles[1].route}`}>
                  {fetch.allArticles[1].title}
                </Link>
              }
          ...
          <div className="section-three">
            <FeaturedBlurb
              heading=":: Discover ::"
              title={
                <Link to={`/articles/${fetch.allArticles[2].route}`}>
                  {fetch.allArticles[2].title}
                </Link>
              }
