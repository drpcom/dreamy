...
const Succubus = () => {
    ...
    const getAllLikes = () => {
        db.collection('succubus').onSnapshot(function (querySnapshot) {
            const data= [];
    ...
    const incrementFlame = () => {
        ...
        db.collection("succubus").doc("flame").update({
    ...
    const incrementLove = () => {
        ...
        db.collection("succubus").doc("love").update({
            addedLikes: increment,
        })
    }
    const incrementSexy = () => {
        ...
        db.collection("succubus").doc("sexy").update({
            addedLikes: increment,
        })
    }
    const incrementNeutral = () => {
        ...
        db.collection("succubus").doc("neutral").update({
            addedLikes: increment,
        })
    }
    const incrementFunny = () => {
        ...
        db.collection("succubus").doc("funny").update({
            addedLikes: increment,
        })
    }
    const incrementScary = () => {
        ...
        db.collection("succubus").doc("scary").update({
            addedLikes: increment,
        })
    }
    const incrementMindblowing = () => {
        ...
        db.collection("succubus").doc("mindblowing").update({
            addedLikes: increment,
        })
    }
    const incrementSad = () => {
        ...
        db.collection("succubus").doc("sad").update({
            addedLikes: increment,
        })
    }
    ...
    return (
        <React.Fragment>
                ...
                interpretation={allArticles[11].interpretation}
                relatedArticles={allArticles[11].relatedArticles}
                />
        </React.Fragment>
    )
}
