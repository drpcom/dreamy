...
const SloMo = () => {
    ...
    const getAllLikes = () => {
        db.collection('slo-mo').onSnapshot(function (querySnapshot) {
            const data= [];
    ...
    const incrementFlame = () => {
        ...
        db.collection("slo-mo").doc("flame").update({
    ...
    const incrementLove = () => {
        ...
        db.collection("slo-mo").doc("love").update({
            addedLikes: increment,
        })
    }
    const incrementSexy = () => {
        ...
        db.collection("slo-mo").doc("sexy").update({
            addedLikes: increment,
        })
    }
    const incrementNeutral = () => {
        ...
        db.collection("slo-mo").doc("neutral").update({
            addedLikes: increment,
        })
    }
    const incrementFunny = () => {
        ...
        db.collection("slo-mo").doc("funny").update({
            addedLikes: increment,
        })
    }
    const incrementScary = () => {
        ...
        db.collection("slo-mo").doc("scary").update({
            addedLikes: increment,
        })
    }
    const incrementMindblowing = () => {
        ...
        db.collection("slo-mo").doc("mindblowing").update({
            addedLikes: increment,
        })
    }
    const incrementSad = () => {
        ...
        db.collection("slo-mo").doc("sad").update({
            addedLikes: increment,
        })
    }
