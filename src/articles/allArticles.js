...
import hopping from '../images/hopping1.jpg';
import school from '../images/school1.jpg';
import confusion from '../images/confusion1.jpg';
import dreamArguing from '../images/dreamArguing1.jpg';
...
import succubus from '../images/succubus.jpg';
...
const allArticles = [
    {
        ...
        overview: [
        "Everyone's had it. You're standing at the edge of a cliff, staring out wistfully into the Great Expanse™ when suddenly, you slip or a gust of wind takes you miraculously off your feet, and bam! You're falling.", 
        `Our brain's ability to simulate weightlessness really is something, isn't it? So much so that this one is a hallmark of <a>feels real</a> and boasts one of the highest chances of triggering <a>true awakening</a> or <a>false awakening</a>. The picture-perfect, story-book version of this is falling off your bed in a tangle of sheets and embarrassment. We call that earning your wings.`, 
        "Falling dreams <em>probably</em> predate humanity. Many of the hairier ancestors in our evolutionary chain spent a fair amount of time in trees and had a healthy fear of falling. And as we know, whenever a mammal fears something, they almost certainly dream about it.",
        ],
        interpretation: "There are a lot of reasons one might have falling dreams. They are commonly associated with anxiety. They can arise from a sense of powerlessness or fear that you aren't ready for something. On the flip side, they can also come from a healthy fear of falling! In this case, the dream <a>represents itself</a>. Symbolically, falling dreams can serve as a reminder to avoid unexpected pitfalls in life. Or the entire purpose can be to <a href=pointless>scare the shit out of you for no good reason</a>.",
